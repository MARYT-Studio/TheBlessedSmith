...
public class ClientProxy extends CommonProxy {
	public static final KeyBinding ChangeMode = new KeyBinding("key.slashblade.mode_change", Keyboard.KEY_V, "key.categories.blessedsmith");
	@Override
	...
	public static void KeyInput(InputEvent.KeyInputEvent event) {
		...
		getNetwork().sendToServer(new PacketKeyMessage(BlessedSmith.MOD_ID));
		}
	}
	@Override
