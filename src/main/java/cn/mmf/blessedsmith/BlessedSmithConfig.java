...
public class BlessedSmithConfig {
	private final static String config = Tags.MOD_ID + ".config.";
	private final static String advanced_mode_config = BlessedSmith.MOD_ID + ".config.advanced_mode.";
	...
	public static void onConfigChanged(ConfigChangedEvent.OnConfigChangedEvent event) {
		if (event.getModID().equals(BlessedSmith.MOD_ID)) {
			ConfigManager.sync(BlessedSmith.MOD_ID, Config.Type.INSTANCE);
		}
	}
}
