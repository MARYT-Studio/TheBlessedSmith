...
public class BladeSakuraBlade {
	...
	public static void BladeRegister(RegisterSlashBladeEvent event) {
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag1, "slashblade.named.sakura");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.sakura", customblade);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.sakura");
		
		ItemStack customblade2 = new ItemStack(BladeLoader.bladeNamed, 1, 0);
		NBTTagCompound tag2 = new NBTTagCompound();
		customblade2.setTagCompound(tag2);
		ItemSlashBladeNamed.CurrentItemName.set(tag2, "slashblade.named.ginkgo");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.ginkgo", customblade2);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.ginkgo");
		
		ItemStack customblade3 = new ItemStack(BladeLoader.bladeNamed, 1, 0);
		NBTTagCompound tag3 = new NBTTagCompound();
		customblade3.setTagCompound(tag3);
		ItemSlashBladeNamed.CurrentItemName.set(tag3, "slashblade.named.yukikage");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.yukikage", customblade3);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.yukikage");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag4, "slashblade.named.kataware");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.kataware", customblade4);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.kataware");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag5, "slashblade.named.shura");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.shura", customblade5);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.shura");
	}
	...
	public static void onRecipeRegister(RegisterSlashBladeRecipeEvent event) {
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.sakura", new RecipeAwakeBladeTLS(
			new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.sakura"),
			"bewitched_blade", BladeLoader.getInstance().getCustomBlade("slashblade.named.sakura"), request, 
			new Object[] {
				"SDS",
				"PBP",
				"SDS",
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.ginkgo", new RecipeAwakeBladeTLS(
				new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.ginkgo"),
				"bewitched_blade", BladeLoader.getInstance().getCustomBlade("slashblade.named.ginkgo"), request, 
				new Object[] {
					"SDS",
					"PBP",
					"SDS",
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.yukikage", new RecipeAwakeBladeTLS(
				new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.yukikage"),
				"bewitched_blade", BladeLoader.getInstance().getCustomBlade("slashblade.named.yukikage"), request, 
				new Object[] {
					"SDS",
					"PBP",
					"SDS",
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.kataware", new RecipeAwakeBladeTLS(
				new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.kataware"),
				"bewitched_blade", BladeLoader.getInstance().getCustomBlade("slashblade.named.kataware"), request, 
				new Object[] {
					"SDS",
					"PBP",
					"SDS",
		...
		ItemStack requestShura = BladeLoader.getInstance().getCustomBlade("slashblade.named.kataware");
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.shura", new RecipeAwakeBladeTLS(
				new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.shura"),
				"sharpness", BladeLoader.getInstance().getCustomBlade("slashblade.named.shura"), requestShura, 
				new Object[] {
					"SDS",
					"PBP",
					"SDS",
