...
public class BladeAmagumo {
	...
	public static void BladeRegister(RegisterSlashBladeEvent event) {
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag1, "slashblade.named.amagumo.wind");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.amagumo.wind", customblade);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.amagumo.wind");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag11, "slashblade.named.amagumo.cloud");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.amagumo.cloud", customblade1);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.amagumo.cloud");
	}
	...
	public static void onRecipeRegister(RegisterSlashBladeRecipeEvent event) {
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.amagumo.wind", new RecipeAwakeBladeTLS(
			new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.amagumo.wind"),
			"sharpness", BladeLoader.getInstance().getCustomBlade("slashblade.named.amagumo.wind"), request, 
			new Object[] {
				"DPS",
				"PAP",
				"BPD",
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.amagumo.cloud", new RecipeAwakeBladeTLS(
			new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.amagumo.cloud"),
			"sharpness", BladeLoader.getInstance().getCustomBlade("slashblade.named.amagumo.cloud"), request, 
			new Object[] {
				"SPD",
				"PAP",
				"DPB",
