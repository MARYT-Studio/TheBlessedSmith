...
public class BladeRoukanTC {
	...
	public static void BladeRegister(RegisterSlashBladeEvent event) {
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag1, "slashblade.named.roukan_xf");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.roukan_xf", customblade);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.roukan_xf");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag11, "slashblade.named.hakurou_xf");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.hakurou_xf", customblade1);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.hakurou_xf");
	}
	...
	private static void recipe() {
		ItemStack request = BladeLoader.getInstance().getCustomBlade("slashblade.named.roukan");
		...
		ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(BlessedSmith.MOD_ID,"slashblade.named.roukan_xf"),
			new InfusionRecipeAwakeBlade("roukan_xf", BladeLoader.getInstance().getCustomBlade("slashblade.named.roukan_xf"), 1,
		...
		ItemStack request1 = BladeLoader.getInstance().getCustomBlade("slashblade.named.hakurou");
		...
		ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(BlessedSmith.MOD_ID,"slashblade.named.hakurou_xf"),
			new InfusionRecipeAwakeBlade("roukan_xf", BladeLoader.getInstance().getCustomBlade("slashblade.named.hakurou_xf"), 1,
