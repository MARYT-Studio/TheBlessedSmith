...
public class ItemSlashBladeEU extends ItemSlashBladeNamedTBS implements IElectricItem, IItemHudInfo, IMultiModeBlade {
	...
	public void addInformation(ItemStack arg0, World arg1, List arg2, ITooltipFlag arg3) {
		...
		arg2.add(I18n.format("info.slashblade.tool.user") + ": "
