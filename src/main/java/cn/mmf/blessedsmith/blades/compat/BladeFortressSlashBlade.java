...
import cn.mmf.blessedsmith.recipe.InfusionRecipeAwakeBlade;
...
public class BladeFortressSlashBlade {
	...
	public static void BladeRegister(RegisterSlashBladeEvent event) {
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag1, "slashblade.named.fortress.thaumium");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.fortress.thaumium", customblade1);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.fortress.thaumium");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag2, "slashblade.named.fortress.elemental");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.fortress.elemental", customblade2);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.fortress.elemental");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag3, "slashblade.named.fortress.void");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.fortress.void", customblade3);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.fortress.void");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag4, "slashblade.named.fortress.crimson");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.fortress.crimson", customblade4);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.fortress.crimson");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag11, "slashblade.named.fortress.thaumium.update");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.fortress.thaumium.update", customblade11);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.fortress.thaumium.update");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag21, "slashblade.named.fortress.elemental.update");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.fortress.elemental.update", customblade21);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.fortress.elemental.update");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag31, "slashblade.named.fortress.void.update");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.fortress.void.update", customblade31);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.fortress.void.update");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag41, "slashblade.named.fortress.crimson.update");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.fortress.crimson.update", customblade41);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.fortress.crimson.update");
	}
	...
	private static void recipe() {
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID, "blessedsmith.handmade_thaum",
				new ShapedOreRecipe(new ResourceLocation(SlashBlade.MOD_ID, "handmade_thaum"),
				BladeLoader.getInstance().getCustomBlade("blessedsmith.handmade_thaum"),
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID, "blessedsmith.handmade_void",
				new ShapedOreRecipe(new ResourceLocation(SlashBlade.MOD_ID, "handmade_void"),
				BladeLoader.getInstance().getCustomBlade("blessedsmith.handmade_void"),
				new Object[] { "  W", " B ", "L H", 'W', BladeLoader.wrapper, 'B',
		...
		ItemStack thaum = BladeLoader.getInstance().getCustomBlade("slashblade.named.fortress.thaumium");
		ItemStack element = BladeLoader.getInstance().getCustomBlade("slashblade.named.fortress.elemental");
		ItemStack voidness = BladeLoader.getInstance().getCustomBlade("slashblade.named.fortress.void");
		ItemStack crimson = BladeLoader.getInstance().getCustomBlade("slashblade.named.fortress.crimson");
		
		ItemStack thaum_update = BladeLoader.getInstance().getCustomBlade("slashblade.named.fortress.thaumium.update");
		ItemStack element_update = BladeLoader.getInstance().getCustomBlade("slashblade.named.fortress.elemental.update");
		ItemStack voidness_update = BladeLoader.getInstance().getCustomBlade("slashblade.named.fortress.void.update");
		ItemStack crimson_update = BladeLoader.getInstance().getCustomBlade("slashblade.named.fortress.crimson.update");
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.fortress.thaumium",
				new RecipeAwakeBladeTLS(new ResourceLocation("blessedsmith","slashblade.named.fortress.thaumium"),"bewitched_blade",
						thaum, reqiredBlade, 
				new Object[]{
				" 8S",
				"8K8",
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.fortress.elemental",
				new RecipeAwakeBladeTLS(new ResourceLocation("blessedsmith","slashblade.named.fortress.elemental"),"bewitched_blade",
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.fortress.void",
				new RecipeAwakeBladeTLS(new ResourceLocation("blessedsmith","slashblade.named.fortress.void"),"bewitched_blade",
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.fortress.crimson",
				new RecipeAwakeBladeTLS(new ResourceLocation("blessedsmith","slashblade.named.fortress.crimson"),"bewitched_blade",
		...
		ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(BlessedSmith.MOD_ID,"slashblade.named.fortress.thaumium.update"),
		...
		ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(BlessedSmith.MOD_ID,"slashblade.named.fortress.element.update"),
		...
		ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(BlessedSmith.MOD_ID,"slashblade.named.fortress.void.update"),
		...
		ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(BlessedSmith.MOD_ID,"slashblade.named.fortress.crimson.update"),
