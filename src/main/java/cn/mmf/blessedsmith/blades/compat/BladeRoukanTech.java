...
public class BladeRoukanTech {
	...
	public static void BladeRegister(RegisterSlashBladeEvent event) {
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag1, "slashblade.named.roukan_tech");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.roukan_tech", customblade);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.roukan_tech");
	}
	...
	public static void onRecipeRegister(RegisterSlashBladeRecipeEvent event) {
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.roukan_tech", new RecipeAwakeBladeTLS(
			new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.roukan_tech"),
			"sharpness", BladeLoader.getInstance().getCustomBlade("slashblade.named.roukan_tech"), request_4, 
			new Object[] {
				"DSD",
				"PBP",
				"DSD",
