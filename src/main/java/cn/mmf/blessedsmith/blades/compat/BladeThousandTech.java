...
public class BladeThousandTech {
	...
	public static void BladeRegister(RegisterSlashBladeEvent event) {
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag1, "slashblade.named.thousand");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.thousand", customblade);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.thousand");
	}

	@SubscribeEvent
	public static void onRecipeRegister(RegisterSlashBladeRecipeEvent event) {
		ItemStack request_4 = BladeLoader.getInstance().getCustomBlade("slashblade.named.nagasada");
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.thousand", new RecipeAwakeBladeTLS(
			new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.thousand"),
			"bunshi", BladeLoader.getInstance().getCustomBlade("slashblade.named.thousand"), request_4,
			new Object[] {
				"DPD",
				"SAS",
				"DBD",
