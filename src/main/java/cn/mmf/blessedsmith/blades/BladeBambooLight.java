...
public class BladeBambooLight {
	...
	public static void BambooRegister(RegisterSlashBladeEvent event) {
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag_top, "slashblade.named.bamboolight_top");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.bamboolight_top", customblade);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.bamboolight_top");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag, "slashblade.named.bamboolight_recluse");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.bamboolight_recluse", customblade_recluse);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.bamboolight_recluse");
	}
	...
	public static void SliverBambooRegister(RegisterSlashBladeEvent event) {
		...
		NBTTagCompound tag_top = new NBTTagCompound();
		customblade.setTagCompound(tag_top);
		ItemSlashBladeNamed.CurrentItemName.set(tag_top, "slashblade.named.silverbamboolight_top");
		ItemSlashBladeNamed.CustomMaxDamage.set(tag_top, 60);
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.silverbamboolight_top", customblade);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.silverbamboolight_top");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag, "slashblade.named.silverbamboolight_blood");
		ItemSlashBladeNamed.CustomMaxDamage.set(tag, 70);
		ItemSlashBladeNamed.IsDefaultBewitched.set(tag, true);
		BladeUtil.getInstance().IsBewitchedActived.set(tag, true);
		ItemSlashBlade.setBaseAttackModifier(tag, 10.0F);
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.silverbamboolight_blood", customblade_recluse);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.silverbamboolight_blood");
	}
	...
	public static void onRecipeRegister(RegisterSlashBladeRecipeEvent event) {
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.bamboolight_top", new RecipeAwakeBladeTLS(
			new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.bamboolight_top"),
			"slashblade_bamboolight", BladeLoader.getInstance().getCustomBlade("slashblade.named.bamboolight_top"), bamboolight, 
			new Object[] {
				"PSP",
				"PSP",
				"PBP",
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.silverbamboolight_top", new RecipeAwakeBladeTLS(
			new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.silverbamboolight_top"),
			"slashblade_sliverbamboolight", BladeLoader.getInstance().getCustomBlade("slashblade.named.silverbamboolight_top"), sliverbamboolight, 
			new Object[] {
				"PSP",
				"PSP",
				"PBP",
		...
		ItemStack bamboolight_top = BladeLoader.getInstance().getCustomBlade("slashblade.named.bamboolight_top");
		ItemStack silverbamboolight_top = BladeLoader.getInstance().getCustomBlade("slashblade.named.silverbamboolight_top");
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.bamboolight_recluse", new RecipeAwakeBladeTLS(
				new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.bamboolight_recluse"),
				"bewitched_blade", BladeLoader.getInstance().getCustomBlade("slashblade.named.bamboolight_recluse"), bamboolight_top, 
				new Object[] {
					"PSP",
					"SBS",
					"PSP",
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.silverbamboolight_blood", new RecipeAwakeBladeTLS(
				new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.silverbamboolight_blood"),
				"bewitched_blade", BladeLoader.getInstance().getCustomBlade("slashblade.named.silverbamboolight_blood"), silverbamboolight_top, 
				new Object[] {
					"PSP",
					"SBS",
					"PSP",
