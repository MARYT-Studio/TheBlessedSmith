...
public class ItemSlashBladeSayaHandmade extends ItemSlashBladeWrapper {
    ...
    public void getSubItems(CreativeTabs tab, NonNullList<ItemStack> subItems) {
        ...
        if (this.isInCreativeTab(CreativeTabs.COMBAT)) return;
        {
        	...
        	subItems.add(item0);
        	BladeLoader.getInstance().registerCustomItemStack("blessedsmith.handmade_saya_0", item0);
        	
            ItemStack item1 = new ItemStack(this);
            NBTTagCompound tag1 = new NBTTagCompound();
            item1.setTagCompound(tag1);
        	ItemSlashBladeNamed.CurrentItemName.set(tag1, "blessedsmith.handmade_saya_1");
        	...
        	subItems.add(item1);
        	BladeLoader.getInstance().registerCustomItemStack("blessedsmith.handmade_saya_1", item1);
        	
            ItemStack item2 = new ItemStack(this);
            NBTTagCompound tag2 = new NBTTagCompound();
            item2.setTagCompound(tag2);
        	ItemSlashBladeNamed.CurrentItemName.set(tag2, "blessedsmith.handmade_saya_2");
        	...
        	subItems.add(item2);
        	BladeLoader.getInstance().registerCustomItemStack("blessedsmith.handmade_saya_2", item2);
        }
    }
