...
public class HandMadeRecipeRegEvent {
	...
	public static void onRecipeRegister(RegisterSlashBladeRecipeEvent event) {
		if(Loader.isModLoaded("tfc")) {
			RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID, "blessedsmith.handmade_saya",
			...
			RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID, "blessedsmith.handmade_saya_1",
					new ShapedOreRecipe(new ResourceLocation(SlashBlade.MOD_ID, "handmade_saya_1"),
					BladeLoader.getInstance().getCustomBlade("blessedsmith.handmade_saya_1"),
			...
			RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID, "blessedsmith.handmade_saya_2",
					new ShapedOreRecipe(new ResourceLocation(SlashBlade.MOD_ID, "handmade_saya_2"),
					BladeLoader.getInstance().getCustomBlade("blessedsmith.handmade_saya_2"),
					new Object[] { " AW", "AB ", "LSH", 'W', SlashBlade.wrapBlade, 'B',
						new ItemStack(ItemLoader.MATERIALS, 1, 0), 'L', "logWood", 'H',
