...
public class BladeYamazakura {
	...
	public static void BladeRegister(RegisterSlashBladeEvent event) {
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag, "slashblade.named.yamazakura.aoi_fake");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.yamazakura.aoi_fake", customblade);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.yamazakura.aoi_fake");

		BladeLoader.getInstance();
		ItemStack customblade1 = new ItemStack(BladeLoader.bladeNamed, 1, 0);
		NBTTagCompound tag1 = new NBTTagCompound();
		customblade1.setTagCompound(tag1);
		ItemSlashBladeNamed.CurrentItemName.set(tag1, "slashblade.named.yamazakura.kadomatsu");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.yamazakura.kadomatsu", customblade1);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.yamazakura.kadomatsu");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag11, "slashblade.named.yamazakura.ume");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.yamazakura.ume", customblade11);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.yamazakura.ume");

		BladeLoader.getInstance();
		ItemStack customblade2 = new ItemStack(BladeLoader.bladeNamed, 1, 0);
		NBTTagCompound tag2 = new NBTTagCompound();
		customblade2.setTagCompound(tag2);
		ItemSlashBladeNamed.CurrentItemName.set(tag2, "slashblade.named.yamazakura.sakura");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.yamazakura.sakura", customblade2);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.yamazakura.sakura");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag21, "slashblade.named.yamazakura.uzuki");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.yamazakura.uzuki", customblade21);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.yamazakura.uzuki");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag22, "slashblade.named.yamazakura.satsuki");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.yamazakura.satsuki", customblade22);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.yamazakura.satsuki");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag221, "slashblade.named.yamazakura.hazuki");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.yamazakura.hazuki", customblade221);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.yamazakura.hazuki");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag222, "slashblade.named.yamazakura.kiku");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.yamazakura.kiku", customblade222);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.yamazakura.kiku");

		BladeLoader.getInstance();
		ItemStack customblade3 = new ItemStack(BladeLoader.bladeNamed, 1, 0);
		NBTTagCompound tag3 = new NBTTagCompound();
		customblade3.setTagCompound(tag3);
		ItemSlashBladeNamed.CurrentItemName.set(tag3, "slashblade.named.yamazakura.shiwasu");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.yamazakura.shiwasu", customblade3);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.yamazakura.shiwasu");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag31, "slashblade.named.yamazakura.shimotsuki");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.yamazakura.shimotsuki", customblade31);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.yamazakura.shimotsuki");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag4, "slashblade.named.yamazakura.minazuki");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.yamazakura.minazuki", customblade4);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.yamazakura.minazuki");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag41, "slashblade.named.yamazakura.fumizuki");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.yamazakura.fumizuki", customblade41);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.yamazakura.fumizuki");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag42, "slashblade.named.yamazakura.kannazuki");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.yamazakura.kannazuki", customblade42);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.yamazakura.kannazuki");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag421, "slashblade.named.yamazakura.kamuy");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.yamazakura.kamuy", customblade421);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.yamazakura.kamuy");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag5, "slashblade.named.yamazakura.aoi");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.yamazakura.aoi", customblade5);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.yamazakura.aoi");
	}

	@SubscribeEvent
	public static void onRecipeRegister(RegisterSlashBladeRecipeEvent event) {
		DropEvent.registerEntityDrop(new ResourceLocation("minecraft", "evocation_illager"),
				new ResourceLocation(BlessedSmith.MOD_ID, "slashblade_white"), 0.5f,
				BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.aoi_fake"), true);
		
		DropEvent.registerEntityDrop(new ResourceLocation("minecraft", "spider"),
				new ResourceLocation(BlessedSmith.MOD_ID, "slashblade_white"), 0.35f,
				BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.kadomatsu"), true);
		DropEvent.registerEntityDrop(new ResourceLocation("minecraft", "stray"),
				new ResourceLocation(BlessedSmith.MOD_ID, "slashblade_white"), 0.45f,
				BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.ume"), true);
		DropEvent.registerEntityDrop(new ResourceLocation("minecraft", "creeper"),
				new ResourceLocation(BlessedSmith.MOD_ID, "slashblade_white"), 0.35f,
				BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.sakura"), true);

		DropEvent.registerEntityDrop(new ResourceLocation("minecraft", "ghast"),
				new ResourceLocation(BlessedSmith.MOD_ID, "slashblade_white"), 0.5f,
				BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.uzuki"), true);
		DropEvent.registerEntityDrop(new ResourceLocation("minecraft", "enderman"),
				new ResourceLocation(BlessedSmith.MOD_ID, "slashblade_white"), 0.35f,
				BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.satsuki"), true);
		DropEvent.registerEntityDrop(new ResourceLocation("minecraft", "blaze"),
				new ResourceLocation(BlessedSmith.MOD_ID, "slashblade_white"), 0.35f,
				BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.hazuki"), true);

		DropEvent.registerEntityDrop(new ResourceLocation("minecraft", "guardian"),
				new ResourceLocation(BlessedSmith.MOD_ID, "slashblade_white"), 0.45f,
				BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.kiku"), true);
		DropEvent.registerEntityDrop(new ResourceLocation("minecraft", "vex"),
				new ResourceLocation(BlessedSmith.MOD_ID, "slashblade_white"), 0.45f,
				BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.shiwasu"), true);
		DropEvent.registerEntityDrop(new ResourceLocation("minecraft", "magma_cube"),
				new ResourceLocation(BlessedSmith.MOD_ID, "slashblade_white"), 0.35f,
				BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.shimotsuki"), true);
		
		ItemStack sb = BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.ume");
		ItemStack reqiredMain = BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.kadomatsu");
		ItemStack reqiredSub = BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.sakura");
		NBTTagCompound reqTag = ItemSlashBlade.getItemTagCompound(sb);
		ItemSlashBlade.KillCount.set(reqTag, Integer.valueOf(50));

		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.yamazakura.minazuki", new RecipeTriBladeTLS(
			new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.yamazakura.minazuki"),
			"slashblade_white", BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.minazuki"), sb,
		...
		sb = BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.minazuki");
		reqiredMain = BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.uzuki");
		reqiredSub = BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.satsuki");
		reqTag = ItemSlashBlade.getItemTagCompound(sb);

		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.yamazakura.fumizuki", new RecipeTriBladeTLS(
			new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.yamazakura.fumizuki"),
			"bewitched_blade", BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.fumizuki"), sb,
			1, 1, reqiredMain, 0, 1, false, reqiredSub, 2, 1, false,
			new Object[] { 
				"GGG",
				"ABC",
		...
		sb = BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.fumizuki");
		reqiredMain = BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.hazuki");
		reqiredSub = BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.kiku");
		reqTag = ItemSlashBlade.getItemTagCompound(sb);
		ItemSlashBlade.KillCount.set(reqTag, Integer.valueOf(100));
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.yamazakura.kannazuki", new RecipeTriBladeTLS(
			new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.yamazakura.kannazuki"),
			"bewitched_blade", BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.kannazuki"), sb,
			1, 1, reqiredMain, 0, 1, false, reqiredSub, 2, 1, false,
			new Object[] { 
				"GGG",
				"ABC",
		...
		sb = BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.kannazuki");
		reqiredMain = BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.shiwasu");
		reqiredSub = BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.shimotsuki");
		reqTag = ItemSlashBlade.getItemTagCompound(sb);
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.yamazakura.kamuy", new RecipeTriBladeTLS(
			new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.yamazakura.kamuy"),
			"bewitched_blade", BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.kamuy"), sb,
			1, 1, reqiredMain, 0, 1, false, reqiredSub, 2, 1, false,
			new Object[] { 
				"GGG",
				"ABC",
		...
		sb = BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.aoi_fake");
		reqTag = ItemSlashBlade.getItemTagCompound(sb);
		ItemSlashBlade.KillCount.set(reqTag, Integer.valueOf(500));
		ItemSlashBlade.ProudSoul.set(reqTag, Integer.valueOf(1000));
		ItemSlashBlade.RepairCount.set(reqTag, Integer.valueOf(1));
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.yamazakura.aoi", new RecipeAwakeBladeTLS(
			new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.yamazakura.aoi"),
			"bewitched_blade", BladeLoader.getInstance().getCustomBlade("slashblade.named.yamazakura.aoi"), sb, 
			new Object[] {
				"SPS",
				"PBP",
				"SPS",
