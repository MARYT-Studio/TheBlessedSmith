...
public class BladeKogawa {
	...
	public static void BladeRegister(RegisterSlashBladeEvent event) {
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag1, "slashblade.named.kogawa_normal");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.kogawa_normal", customblade);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.kogawa_normal");

		ItemStack customblade2 = new ItemStack(BladeLoader.bladeNamed, 1, 0);
		NBTTagCompound tag2 = new NBTTagCompound();
		customblade2.setTagCompound(tag2);
		ItemSlashBladeNamed.CurrentItemName.set(tag2, "slashblade.named.kogawa_rare");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.kogawa_rare", customblade2);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.kogawa_rare");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag3, "slashblade.named.kogawa_super");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.kogawa_super", customblade3);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.kogawa_super");
	}
	...
	public static void onRecipeRegister(RegisterSlashBladeRecipeEvent event) {
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.kogawa_normal", new RecipeAwakeBladeTLS(
			new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.kogawa_normal"),
			"slashblade_white", BladeLoader.getInstance().getCustomBlade("slashblade.named.kogawa_normal"), request, 
			new Object[] {
				"PSP",
				"SBS",
				"PSP",
		...
		ItemStack request_rare = BladeLoader.getInstance().getCustomBlade("slashblade.named.kogawa_normal");
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.kogawa_rare", new RecipeAwakeBladeTLS(
			new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.kogawa_rare"),
			"slashblade_white", BladeLoader.getInstance().getCustomBlade("slashblade.named.kogawa_rare"), request_rare, 
			new Object[] {
				"PSP",
				"SBS",
				"PSP",
		...
		ItemStack request_super = BladeLoader.getInstance().getCustomBlade("slashblade.named.kogawa_rare");
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.kogawa_super", new RecipeAwakeBladeTLS(
			new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.kogawa_super"),
			"slashblade_white", BladeLoader.getInstance().getCustomBlade("slashblade.named.kogawa_super"), request_super, 
			new Object[] {
				"PSP",
				"PSP",
				"SBS",
