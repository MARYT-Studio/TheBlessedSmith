package cn.mmf.blessedsmith.blades.vanilla;
...
public class VanillaBladeRegister {
	private static String[] defaultBewitched = new String[]{
			"slashblade.named.tagayasan",
			"slashblade.named.crimsoncherry",
			"slashblade.named.nihilex",
			"slashblade.named.nihilul",
			"slashblade.named.nihilbx",
			"slashblade.named.yamato",
			
			"slashblade.named.sange",
			"slashblade.named.orotiagito",
			"slashblade.named.kirisaya",
			
			"slashblade.named.kamuy.water",
			"slashblade.named.kamuy.fire",
			"slashblade.named.kamuy.lightning",
	};
	@SubscribeEvent
	...
	public static void onRecipeRegister(RegisterSlashBladeRecipeEvent event) {	
		...
		SlashBlade.addRecipe("slashblade.named.yamato",
				new RecipeAwakeBladeTLS(new ResourceLocation(SlashBlade.MOD_ID, "yamato"), "bewitched_blade",
						SlashBlade.getCustomBlade("slashblade.named.yamato"),
						SlashBlade.getCustomBlade("slashblade.named.yamato.reqired"), "XXX", "XBX", "XXX",
						'X', SlashBlade.getCustomBlade(SlashBlade.SphereBladeSoulStr), 'B',
						SlashBlade.getCustomBlade("slashblade.named.yamato.reqired")));
		SlashBlade.addRecipe("slashblade.named.agito",
				new RecipeAwakeBladeTLS(new ResourceLocation(SlashBlade.MOD_ID, "agito"),"bewitched_blade",
						SlashBlade.getCustomBlade("slashblade.named.agito"),
						SlashBlade.getCustomBlade("slashblade.named.agito.reqired"), " X ", "XBX", " X ",
						'X', SlashBlade.getCustomBlade(SlashBlade.ProudSoulStr), 'B',
						SlashBlade.getCustomBlade("slashblade.named.agito.reqired")));
		SlashBlade.addRecipe("slashblade.named.orotiagito",
				new RecipeAwakeBladeTLS(new ResourceLocation(SlashBlade.MOD_ID, "agito_ex"),"bewitched_blade",
						SlashBlade.getCustomBlade("slashblade.named.orotiagito"),
						SlashBlade.getCustomBlade("slashblade.named.orotiagito.reqired"), "PXP", "XBX",
						"PXP", 'X', SlashBlade.getCustomBlade(SlashBlade.SphereBladeSoulStr), 'P',
						SlashBlade.getCustomBlade(SlashBlade.ProudSoulStr), 'B',
						SlashBlade.getCustomBlade("slashblade.named.orotiagito.reqired")));
		SlashBlade.addRecipe("slashblade.named.orotiagito.seald",
				new RecipeAwakeBladeTLS(new ResourceLocation(SlashBlade.MOD_ID, "agito2"),"bewitched_blade",
						SlashBlade.getCustomBlade("slashblade.named.orotiagito.seald"),
						SlashBlade.getCustomBlade("slashblade.named.orotiagito.seald.reqired"), " X ", "XBX",
						" X ", 'X', SlashBlade.getCustomBlade(SlashBlade.ProudSoulStr), 'B',
						SlashBlade.getCustomBlade("slashblade.named.orotiagito.seald.reqired")));
		...
		SlashBlade.addRecipe("slashblade.named.tagayasan",
				new RecipeAwakeBladeTLS(new ResourceLocation(SlashBlade.MOD_ID, "tagayasan"), "bewitched_blade",
						SlashBlade.getCustomBlade("slashblade.named.tagayasan"), tagayasanreqiredBlade,
		...
		SlashBlade.addRecipe("slashblade.named.yuzukitukumo",
				new RecipeAwakeBlade(new ResourceLocation(SlashBlade.MOD_ID, "tukumo"),
						SlashBlade.getCustomBlade("slashblade.named.yuzukitukumo"),
	...
	public static void initSJAPBlades(RegisterSlashBladeRecipeEvent event) {
		if (!Loader.isModLoaded(SJAP.MOD_ID))
			...
			if(!Loader.isModLoaded("twilightforest")) {
				ItemStack darkraven = SlashBlade.getCustomBlade("slashblade.named.darkraven");
				ItemStack doutanuki = SlashBlade.getCustomBlade("slashblade.named.doutanuki");
				SlashBlade.addRecipe("slashblade.named.darkraven",
					new RecipeAwakeBlade(new ResourceLocation("slashblade", 
						"slashblade.named.darkraven"), darkraven, doutanuki,
						new Object[] {
							" FQ", "SQ ", "B  ",
	       ...
	       ItemStack sphere = SlashBlade.findItemStack(SlashBlade.MOD_ID, SlashBlade.SphereBladeSoulStr, 1);
	        ItemStack blade_base = SlashBlade.getCustomBlade("slashblade.named.kamuy.base");
	        ItemStack blade_water = SlashBlade.getCustomBlade("slashblade.named.kamuy.water");
	        ItemStack blade_fire = SlashBlade.getCustomBlade("slashblade.named.kamuy.fire");
	        ItemStack blade_lightning = SlashBlade.getCustomBlade("slashblade.named.kamuy.lightning");
			...
			SlashBlade.addRecipe("slashblade.named.kamuy.base", new RecipeAwakeBladeTLS(new ResourceLocation("slashblade","slashblade.named.kamuy.base"),"bewitched_blade", blade_base, reqblade_base, new Object[]{
					"SQS","IKI","SBS",'S', sphere,'K', reqblade_base,'Q', "gemQuartz",'I', "blockIron",'B', Items.BOOK
			}));
			ItemStack reqblade = SlashBlade.getCustomBlade("slashblade.named.kamuy.base");
			...
			SlashBlade.addRecipe("slashblade.named.kamuy.water", new RecipeAwakeBladeTLS(new ResourceLocation("slashblade","slashblade.named.kamuy.water"),"bewitched_blade", blade_water, reqblade, new Object[]{
					"S8S","4K6","S2S",
					'S', sphere,'K', reqblade,'8',"blockLapis",'4', Blocks.ICE,'6', Blocks.SNOW,'2', Items.WATER_BUCKET
			}));
			SlashBlade.addRecipe("slashblade.named.kamuy.fire", new RecipeAwakeBladeTLS(new ResourceLocation("slashblade","slashblade.named.kamuy.fire"),"bewitched_blade", blade_fire, reqblade, new Object[]{
					"S8S","4K6","S2S",
					'S', sphere,'K', reqblade,'8',"blockRedstone",'4',Items.FIRE_CHARGE,'6', Items.BLAZE_ROD,'2', Items.LAVA_BUCKET
			}));
			SlashBlade.addRecipe("slashblade.named.kamuy.lightning", new RecipeAwakeBladeTLS(new ResourceLocation("slashblade","slashblade.named.kamuy.lightning"),"bewitched_blade", blade_lightning, reqblade, new Object[]{
					"S8S","4K6","S2S",
		    ...
		    ItemStack blade = SlashBlade.getCustomBlade("slashblade.named.kirisaya");
		    ...
		    SlashBlade.addRecipe("slashblade.named.kirisaya", new RecipeKiriSayaTLS(new ResourceLocation("slashblade","slashblade.named.kirisaya"),"sharpness", blade, reqiredBlade, sphere1, new Object[]{
	...
	public static void initNihilRecipes(RegisterSlashBladeRecipeEvent event) {
		...
		if (!BlessedSmithConfig.advanced_mode)
			return;
		final String namenl = "slashblade.named.nihil";
		final String nameex = "slashblade.named.nihilex";
		final String nameul = "slashblade.named.nihilul";
		final String namebx = "slashblade.named.nihilbx";
		final String namecc = "slashblade.named.crimsoncherry";
