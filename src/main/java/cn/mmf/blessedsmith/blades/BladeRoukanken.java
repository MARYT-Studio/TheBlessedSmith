...
public class BladeRoukanken {
	...
	public static void BladeRegister(RegisterSlashBladeEvent event) {
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag1, "slashblade.named.kanrou_fake");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.kanrou_fake", customblade);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.kanrou_fake");
		
		ItemStack customblade2 = new ItemStack(BladeLoader.bladeNamed, 1, 0);
		NBTTagCompound tag2 = new NBTTagCompound();
		customblade2.setTagCompound(tag2);
		ItemSlashBladeNamed.CurrentItemName.set(tag2, "slashblade.named.kanrou");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.kanrou", customblade2);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.kanrou");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag3, "slashblade.named.roukan");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.roukan", customblade3);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.roukan");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag4, "slashblade.named.roukan_nether");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.roukan_nether", customblade4);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.roukan_nether");
	}
	...
	public static void onRecipeRegister(RegisterSlashBladeRecipeEvent event) {
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.kanrou_fake", new RecipeAwakeBladeTLS(
			new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.kanrou_fake"),
			"sakura_blade", BladeLoader.getInstance().getCustomBlade("slashblade.named.kanrou_fake"), request_1, 
			new Object[] {
				"PDP",
				"DSD",
				"PBP",
		...
		ItemStack request_2 = BladeLoader.getInstance().getCustomBlade("slashblade.named.kanrou_fake");
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.kanrou", new RecipeAwakeBladeTLS(
			new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.kanrou"),
			"sakura_blade", BladeLoader.getInstance().getCustomBlade("slashblade.named.kanrou"), request_2, 
			new Object[] {
				"PSD",
				"SDS",
				"BSP",
		...
		ItemStack request_3 = BladeLoader.getInstance().getCustomBlade("slashblade.named.kanrou");
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.roukan", new RecipeAwakeBladeTLS(
			new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.roukan"),
			"sakura_blade", BladeLoader.getInstance().getCustomBlade("slashblade.named.roukan"), request_3, 
			new Object[] {
				"SPD",
				"PBP",
				"DPS",
		...
		ItemStack request_4 = BladeLoader.getInstance().getCustomBlade("slashblade.named.roukan");
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.roukan_nether", new RecipeAwakeBladeTLS(
			new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.roukan_nether"),
			"sharpness", BladeLoader.getInstance().getCustomBlade("slashblade.named.roukan_nether"), request_4, 
			new Object[] {
				"DSD",
				"PBP",
				"DSD",
