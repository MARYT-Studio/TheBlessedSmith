...
import cn.mmf.blessedsmith.recipe.RecipeMunin;
...
public class BladeSmith {
	...
	public static void BladeRegister(RegisterSlashBladeEvent event) {
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag1, "slashblade.named.smith.final");
		...
		BladeLoader.getInstance().registerCustomItemStack("slashblade.named.smith.final", customblade);
		ItemSlashBladeNamedTBS.NamedBlades.add("slashblade.named.smith.final");
	}

	@SubscribeEvent
	public static void onRecipeRegister(RegisterSlashBladeRecipeEvent event) {
		ItemStack sb = BladeLoader.getInstance().getCustomBlade("slashblade.named.nagasada");
		ItemStack reqiredMain = BladeLoader.getInstance().getCustomBlade("slashblade.named.amagumo.wind");
		ItemStack reqiredSub = BladeLoader.getInstance().getCustomBlade("slashblade.named.amagumo.cloud");
		...
		RecipesUtil.getInstance().addRecipe(BlessedSmith.MOD_ID,"slashblade.named.smith.final", new RecipeMunin(
			new ResourceLocation(BlessedSmith.MOD_ID, "slashblade.named.smith.final"),
			advancements, BladeLoader.getInstance().getCustomBlade("slashblade.named.smith.final"), sb,
