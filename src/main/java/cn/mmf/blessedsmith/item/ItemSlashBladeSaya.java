...
public class ItemSlashBladeSaya extends ItemSlashBladeWrapper {
	...
	public void addInformation(ItemStack arg0, World arg1, List arg2, ITooltipFlag arg3) {
		...
		if(BladeUtil.getInstance().getname(nbt) != null){
			...
			arg2.add(TextFormatting.GOLD + I18n.format("blades.crafter")+":"+TextFormatting.GRAY+I18n.format("blessedsmith.name.unnamed_smith"));
		}
	}
    private ResourceLocationRaw texture = new ResourceLocationRaw("slashblade","model/wooden_saya.png");
    @Override
