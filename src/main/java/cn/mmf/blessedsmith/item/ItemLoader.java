...
import cn.mmf.blessedsmith.CommonProxy;
...
public class ItemLoader {
	public static ItemBase MATERIALS = new ItemBase(BlessedSmith.MOD_ID,"materials", 64,
            "wooden_blade",
            "bamboo_blade",
            "yakibatsuchi",
            "sakura",
            ...
            "sakura_ingot",
            "sakura_sphere");
	public static ItemBase SCROLL = new ItemBase(BlessedSmith.MOD_ID,"scroll", 1,
	...
	public static ItemBase BLADE = new ItemBase(BlessedSmith.MOD_ID,"blade",1,
		"blade",
		"blade_2",
		"blade_3",//2
		"blade_unfinished",
	...
	public static Item hammer = new ItemHammer().setRegistryName("forging_hammer");
    ...
    public void registerItem(Item item) {
        ...
        ItemRegister.getInstance().register(item);
    }
