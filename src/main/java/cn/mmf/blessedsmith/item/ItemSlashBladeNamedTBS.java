...
public class ItemSlashBladeNamedTBS extends ItemSlashBladeTBS {
	public ItemSlashBladeNamedTBS(ToolMaterial par2EnumToolMaterial, float baseAttackModifiers) {
    ...
    public ResourceLocationRaw getModelTexture(ItemStack par1ItemStack){
        ...
        return ((ItemSlashBladeNamedTBS)par1ItemStack.getItem()).getModelTexture();
    }
