...
public class BladeFortressSlashBlade {
	...
	public static void BladeRegister(RegisterSlashBladeEvent event) {
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag1, "lastsmith.slashblade.named.fortress.thaumium");
		...
		BladeLoader.getInstance().registerCustomItemStack("lastsmith.slashblade.named.fortress.thaumium", customblade1);
		ItemSlashBladeNamedTLS.NamedBlades.add("lastsmith.slashblade.named.fortress.thaumium");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag2, "lastsmith.slashblade.named.fortress.elemental");
		...
		BladeLoader.getInstance().registerCustomItemStack("lastsmith.slashblade.named.fortress.elemental", customblade2);
		ItemSlashBladeNamedTLS.NamedBlades.add("lastsmith.slashblade.named.fortress.elemental");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag3, "lastsmith.slashblade.named.fortress.void");
		...
		BladeLoader.getInstance().registerCustomItemStack("lastsmith.slashblade.named.fortress.void", customblade3);
		ItemSlashBladeNamedTLS.NamedBlades.add("lastsmith.slashblade.named.fortress.void");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag4, "lastsmith.slashblade.named.fortress.crimson");
		...
		BladeLoader.getInstance().registerCustomItemStack("lastsmith.slashblade.named.fortress.crimson", customblade4);
		ItemSlashBladeNamedTLS.NamedBlades.add("lastsmith.slashblade.named.fortress.crimson");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag11, "lastsmith.slashblade.named.fortress.thaumium.update");
		...
		BladeLoader.getInstance().registerCustomItemStack("lastsmith.slashblade.named.fortress.thaumium.update", customblade11);
		ItemSlashBladeNamedTLS.NamedBlades.add("lastsmith.slashblade.named.fortress.thaumium.update");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag21, "lastsmith.slashblade.named.fortress.elemental.update");
		...
		BladeLoader.getInstance().registerCustomItemStack("lastsmith.slashblade.named.fortress.elemental.update", customblade21);
		ItemSlashBladeNamedTLS.NamedBlades.add("lastsmith.slashblade.named.fortress.elemental.update");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag31, "lastsmith.slashblade.named.fortress.void.update");
		...
		BladeLoader.getInstance().registerCustomItemStack("lastsmith.slashblade.named.fortress.void.update", customblade31);
		ItemSlashBladeNamedTLS.NamedBlades.add("lastsmith.slashblade.named.fortress.void.update");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag41, "lastsmith.slashblade.named.fortress.crimson.update");
		...
		BladeLoader.getInstance().registerCustomItemStack("lastsmith.slashblade.named.fortress.crimson.update", customblade41);
		ItemSlashBladeNamedTLS.NamedBlades.add("lastsmith.slashblade.named.fortress.crimson.update");
	}
	...
	private static void recipe() {
		...
		ItemStack thaum = BladeLoader.getInstance().getCustomBlade("lastsmith.slashblade.named.fortress.thaumium");
		ItemStack element = BladeLoader.getInstance().getCustomBlade("lastsmith.slashblade.named.fortress.elemental");
		ItemStack voidness = BladeLoader.getInstance().getCustomBlade("lastsmith.slashblade.named.fortress.void");
		ItemStack crimson = BladeLoader.getInstance().getCustomBlade("lastsmith.slashblade.named.fortress.crimson");
		
		ItemStack thaum_update = BladeLoader.getInstance().getCustomBlade("lastsmith.slashblade.named.fortress.thaumium.update");
		ItemStack element_update = BladeLoader.getInstance().getCustomBlade("lastsmith.slashblade.named.fortress.elemental.update");
		ItemStack voidness_update = BladeLoader.getInstance().getCustomBlade("lastsmith.slashblade.named.fortress.void.update");
		ItemStack crimson_update = BladeLoader.getInstance().getCustomBlade("lastsmith.slashblade.named.fortress.crimson.update");
		RecipesUtil.getInstance().addRecipe(TLSMain.MOD_ID,"lastsmith.slashblade.named.fortress.thaumium",
				new RecipeAwakeBladeTLS(new ResourceLocation("lastsmith","lastsmith.slashblade.named.fortress.thaumium"),"bewitched_blade", 
						thaum, reqiredBlade, 
				new Object[]{
				" 8S",
				"8K8",
		...
		RecipesUtil.getInstance().addRecipe(TLSMain.MOD_ID,"lastsmith.slashblade.named.fortress.elemental",
				new RecipeAwakeBladeTLS(new ResourceLocation("lastsmith","lastsmith.slashblade.named.fortress.elemental"),"bewitched_blade", 
		...
		RecipesUtil.getInstance().addRecipe(TLSMain.MOD_ID,"lastsmith.slashblade.named.fortress.void",
				new RecipeAwakeBladeTLS(new ResourceLocation("lastsmith","lastsmith.slashblade.named.fortress.void"),"bewitched_blade", 
		...
		RecipesUtil.getInstance().addRecipe(TLSMain.MOD_ID,"lastsmith.slashblade.named.fortress.crimson",
				new RecipeAwakeBladeTLS(new ResourceLocation("lastsmith","lastsmith.slashblade.named.fortress.crimson"),"bewitched_blade", 
		...
		ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(TLSMain.MOD_ID,"lastsmith.slashblade.named.fortress.thaumium.update"),
		...
		ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(TLSMain.MOD_ID,"lastsmith.slashblade.named.fortress.element.update"),
		...
		ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(TLSMain.MOD_ID,"lastsmith.slashblade.named.fortress.void.update"),
		...
		ThaumcraftApi.addInfusionCraftingRecipe(new ResourceLocation(TLSMain.MOD_ID,"lastsmith.slashblade.named.fortress.crimson.update"),
