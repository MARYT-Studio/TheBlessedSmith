...
public class BladeRequiem {
	...
	public static void BladeRegister(RegisterSlashBladeEvent event) {
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag, "lastsmith.slashblade.named.scorn_rust");
		...
		BladeLoader.getInstance().registerCustomItemStack("lastsmith.slashblade.named.scorn_rust", customblade);
		ItemSlashBladeNamedTLS.NamedBlades.add("lastsmith.slashblade.named.scorn_rust");

		ItemStack customblade1 = new ItemStack(BladeLoader.bladeNamed, 1, 0);
		NBTTagCompound tag1 = new NBTTagCompound();
		customblade1.setTagCompound(tag1);
		ItemSlashBladeNamed.CurrentItemName.set(tag1, "lastsmith.slashblade.named.scorn_sealed");
		...
		BladeLoader.getInstance().registerCustomItemStack("lastsmith.slashblade.named.scorn_sealed", customblade1);
		ItemSlashBladeNamedTLS.NamedBlades.add("lastsmith.slashblade.named.scorn_sealed");
		...
		ItemSlashBladeNamed.CurrentItemName.set(tag2, "lastsmith.slashblade.named.scorn");
		...
		BladeLoader.getInstance().registerCustomItemStack("lastsmith.slashblade.named.scorn", customblade2);
		ItemSlashBladeNamedTLS.NamedBlades.add("lastsmith.slashblade.named.scorn");
	}
	...
	public static void onRecipeRegister(RegisterSlashBladeRecipeEvent event) {
		...
		DropEvent.registerEntityDrop(new ResourceLocation("twilightforest", "lich"),
				new ResourceLocation(TLSMain.MOD_ID, "bewitched_blade"), 1F,
				BladeLoader.getInstance().getCustomBlade("lastsmith.slashblade.named.scorn_rust"), true);
		ItemStack custombladeReqired = BladeLoader.getInstance().getCustomBlade("lastsmith.slashblade.named.scorn_rust");
		...
		RecipesUtil.getInstance().addRecipe(TLSMain.MOD_ID,"lastsmith.slashblade.named.scorn_sealed",new RecipeAwakeBladeTLS(new ResourceLocation(TLSMain.MOD_ID, "lastsmith.slashblade.named.scorn_sealed"),
			"bewitched_blade", BladeLoader.getInstance().getCustomBlade("lastsmith.slashblade.named.scorn_sealed"), custombladeReqired,
			new Object[] {
				"ADA",
				"DBD",
				"ADA", 
		...
		ItemStack custombladeReqired1 = BladeLoader.getInstance().getCustomBlade("lastsmith.slashblade.named.scorn_sealed");
		...
		RecipesUtil.getInstance().addRecipe(TLSMain.MOD_ID,"lastsmith.slashblade.named.scorn",new RecipeAwakeBladeTLS(new ResourceLocation(TLSMain.MOD_ID, "lastsmith.slashblade.named.scorn"),
			"bewitched_blade", BladeLoader.getInstance().getCustomBlade("lastsmith.slashblade.named.scorn"), custombladeReqired1,
			new Object[] {
				"DAD",
				"ABA",
				"DAD", 
